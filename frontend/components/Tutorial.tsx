        ...
        <>
            ...
            <div>
                ...
                <div className={"box"} style={{height: "auto", paddingBottom: "5vh"}}>
                    ...
                    <img style={{border: "solid black 1px", justifySelf: "center"}} src={HomePage} alt={"Picture of Home Page"}/>
                ...
                <div className={"box"} style={{height: "auto", paddingBottom: "5vh"}}>
                    ...
                    <img style={{border: "solid black 1px", justifySelf: "center"}} src={HomeSQLGen} alt={"Generate SQL Page Button"}/>
                    ...
                    <img style={{border: "solid black 1px", justifySelf: "center"}} src={GenChooseFile} alt={"Page with choose file circled"}/>
                    <img style={{border: "solid black 1px", justifySelf: "center"}} src={GenERDPreview} alt={"Box with ERD preview"}/>
                    ...
                    <img style={{border: "solid black 1px", justifySelf: "center"}} src={GenGeneratedCode} alt={"Picture of all three boxes filled"}/>
                </div>
                <div className={"box"} style={{height: "auto", paddingBottom: "5vh"}}>
                    ...
                    <img style={{border: "solid black 1px", justifySelf: "center"}} src={HomeComp} alt={"Code Comparison Page Button"}/>
                    ...
                    <img style={{border: "solid black 1px", justifySelf: "center"}} src={CompChooseFile} alt={"Page with choose file circled"}/>
                    <h3 className={"h3-tut"}>The LLM will think and generate code from the ERD in the far left box below.</h3>
                    <img style={{border: "solid black 1px", justifySelf: "center"}} src={CompWithGenCode} alt={"Page with code generated in leftmost box"}/>
                    ...
                    <img style={{border: "solid black 1px", justifySelf: "center"}} src={CompPressComp} alt={"Page with compare button circles"}/>
                    <h3 className={"h3-tut"}>The results of the comparison will appear in the rightmost box</h3>
                    <img style={{border: "solid black 1px", justifySelf: "center"}} src={CompCompleteComparison} alt={"Full page with all three boxes having content"}/>
                </div>
            </div>
            <Footer/>
        </>
