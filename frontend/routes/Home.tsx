            ...
            <Header />
                ...
                <div className={"w-1/2 mx-auto text-center"}>
                    <h2 className={"text-center"} style={{fontSize:'2vh'}}>
                        ESAPT aims to help students and educators bridge the gap between understanding conceptual database models as represented by Entity Relationship Diagrams, also known as ERDs, into executable code.
                        ESAPT, applies the image recognition and natural language processes powered by Large Language Models (LLMs) such as Google’s Gemini AI to automate this translation process.
                    </h2>
                </div>
